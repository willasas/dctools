...
def test_preview_duplicates_gui():
    """测试重复文件预览功能的GUI显示"""
    print("开始测试重复文件预览功能的GUI显示...")
    ...
    try:
        ...
        # 测试预览重复文件
        print("\n测试预览重复文件...")
        duplicate_count, preview_details = preview_duplicates(test_dir, method="hash", recursive=True)
